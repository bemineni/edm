...
setup(
    ...
    long_description="Elastic Search data manger with transaction support. *****SAMMY***** 133740 wants to put his name",
    url="www.vertexdblib.com",
    ...
    classifiers=[
           ...
           'Topic :: Software Development :: Database library',
           # Pick your license as you wish (should match "license" above)
           'License :: VertexDB License',

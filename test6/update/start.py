...
if __name__ == "__main__":
    ...
    try:
        ...
        edm.connection.create(index='group', doc_type='doc', id='g100',
                              body={
                                    "gid": 234,
                                    "owner": "bemineni",
                                    "name": "Sammy",
        ...
        edm.update({'_index': 'group',
                    '_type': "doc",
                    '_id': 'g100',
                    '_source': {'grp_hash': '12345',
                                'name': "Srikanth"
                                }
                    })
        ...
        data = edm.connection.get_source(index='group', doc_type="doc", id='g100')
        ...
        edm.connection.delete(index='group', doc_type="doc", id="g100")
